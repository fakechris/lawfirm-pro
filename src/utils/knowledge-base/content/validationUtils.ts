...
export class ContentValidationUtils {
  // Content Validation
  static validateContent(content: Partial<KnowledgeBaseContent>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  // Version Validation
  static validateVersion(version: Partial<KnowledgeBaseContentVersion>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  // Template Validation
  static validateTemplate(template: Partial<ContentTemplate>): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  static validateVariableSchema(schema: any[]): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  static validateContentSize(content: string, maxSize: number = 1000000): { isValid: boolean; size: number; errors: string[] } {
  ...
  // Category Validation
  static validateCategory(category: string): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  // Workflow Validation
  static validateWorkflowStage(stage: any): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  static validateTrainingModule(module: any): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
  ...
  static validateAssessment(assessment: any): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
