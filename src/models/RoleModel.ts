...
export class RoleModel {
  ...
  static async update(id: string, data: Partial<Omit<Role, 'id' | 'createdAt' | 'updatedAt'>>): Promise<Role | null> {
  ...
  static async createSystemRoles(): Promise<void> {
    const systemRoles = [
      {
        name: 'super_admin',
        displayName: '超级管理员',
...
export class PermissionModel {
  ...
  static async update(id: string, data: Partial<Omit<Permission, 'id' | 'createdAt' | 'updatedAt'>>): Promise<Permission | null> {
  ...
  static async createSystemPermissions(): Promise<void> {
