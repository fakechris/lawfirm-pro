import { Document, DocumentVersion, DocumentTemplate, EvidenceItem, EvidenceChain, DocumentWorkflow, DocumentWorkflowStep, User, Case } from '@prisma/client';
...
declare module '@prisma/client' {
    interface PrismaClient {
        ...
        evidenceItem: {
            ...
            }) => Promise<EvidenceItemWithDetails | null>;
        };
        searchIndex: {
