...
describe('AlipayService', () => {
    ...
    describe('buildAlipayParams', () => {
        it('should build correct Alipay parameters', () => {
            ...
            const params = alipayService.buildAlipayParams(request);
    ...
    describe('generateSign', () => {
        it('should generate RSA2 signature', () => {
            ...
            const signature = alipayService.generateSign(params, 'RSA2');
        ...
        it('should generate RSA signature', () => {
            ...
            const signature = alipayService.generateSign(params, 'RSA');
            expect(signature).toBe('mock_signature');
...
//# sourceMappingURL=AlipayService.test.js.map