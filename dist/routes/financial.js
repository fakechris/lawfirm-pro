...
const FinancialController_1 = require("../controllers/financial/FinancialController");
const FinancialService_1 = require("../services/financial/FinancialService");
const client_1 = require("@prisma/client");
const router = (0, express_1.Router)();
const prisma = new client_1.PrismaClient();
const financialService = new FinancialService_1.FinancialService(prisma);
const financialController = new FinancialController_1.FinancialController(financialService);
