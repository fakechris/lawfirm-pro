...
const documentService_1 = require("../src/services/documents/documentService");
...
describe('DocumentService', () => {
    ...
    beforeAll(async () => {
        ...
        documentService = new documentService_1.DocumentService(prisma);
    });
    afterAll(async () => {
    ...
    describe('uploadDocument', () => {
        it('should upload a valid document successfully', async () => {
            ...
            const result = await documentService.uploadDocument(testBuffer, 'test-document.txt', 'text/plain', {
        ...
        it('should reject invalid MIME type', async () => {
            ...
            const result = await documentService.uploadDocument(testBuffer, 'test.exe', 'application/x-executable', {
                uploadedBy: 'test-user-id'
            });
        ...
        it('should reject invalid tags', async () => {
            const testBuffer = Buffer.from('test content');
            const result = await documentService.uploadDocument(testBuffer, 'test.txt', 'text/plain', {
                uploadedBy: 'test-user-id',
    ...
    describe('getDocument', () => {
        it('should retrieve an existing document', async () => {
            ...
            const testBuffer = Buffer.from(testContent);
            const uploadResult = await documentService.uploadDocument(testBuffer, 'retrieval-test.txt', 'text/plain', {
                uploadedBy: 'test-user-id',
    ...
    describe('searchDocuments', () => {
        it('should search documents by filename', async () => {
            ...
            const testBuffer = Buffer.from(testContent);
            await documentService.uploadDocument(testBuffer, 'search-test-document.txt', 'text/plain', {
                uploadedBy: 'test-user-id',
    ...
    describe('downloadDocument', () => {
        it('should download the latest version of a document', async () => {
            ...
            const testBuffer = Buffer.from(testContent);
            await documentService.uploadDocument(testBuffer, 'download-test.txt', 'text/plain', {
                uploadedBy: 'test-user-id',
        ...
        it('should download a specific version of a document', async () => {
            ...
            const newBuffer = Buffer.from(newContent);
            await documentService.createVersion(document.id, newBuffer, 'version-download-test-v2.txt', 'text/plain', 'Second version');
