...
exports.KnowledgeCard = void 0;
const react_1 = __importDefault(require("react"));
const KnowledgeCard = ({ article, onClick, contentTypeLabel, accessLevelLabel, }) => {
    ...
    return (<div onClick={onClick} className="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md hover:border-blue-300 transition-all duration-200 cursor-pointer group">
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          {article.isFeatured && (<div className="ml-2 flex-shrink-0">
        ...
        {article.summary && (<p className="text-gray-600 text-sm mb-4 line-clamp-3">
            {article.summary}
          </p>)}
        ...
        {article.tags && article.tags.length > 0 && (<div className="mb-4">
...
exports.KnowledgeCard = KnowledgeCard;
